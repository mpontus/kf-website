...
export function toggleDisplay(query) {
  return () => {
...
<Section Heading={props => <Heading Text={props => <Text whiteSpace="nowrap" {...props} />} badge={badge} {...props} />} headline="Work with us">
...
Learn more about who we are and why you should join <a onClick={toggleDisplay('#embedded-video')}>here</a>.

<Box id="embedded-video" style={{ display: 'none' }} maxWidth="560px">
  <Box position="relative" overflow="hidden" height="0" pt={`${100 / (16 / 9)}%`}>
    <Box
      as="iframe"
      position="absolute"
      top="0"
      ...
      width="100%"
      height="100%"
      src="https://www.youtube.com/embed/h8tfJ9EtIpY"
